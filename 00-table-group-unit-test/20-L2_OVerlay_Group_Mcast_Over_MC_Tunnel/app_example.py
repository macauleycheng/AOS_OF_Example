...
class app_example(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        #shall a VTEP phy_port same with "of-agent vni 10 multicast 224.1.1.1 nexthop 20"
        #"of-agent nexthop 20 destination 01-00-5e-01-01-01 ethernet 1/2 vid 2"
        #used phy_port.
        #And currently we only provide one port ouput multicast packet
        ...
        self.add_group(datapath, ofproto.OFPGT_ALL, 0x8000ac01, buckets)
        ...
        #add bridge flow        
        actions = [parser.OFPActionGroup(0x8000ac01)]        
        ...
        match.set_dl_dst(mac.haddr_to_bin("01:00:5e:01:01:01"))        
