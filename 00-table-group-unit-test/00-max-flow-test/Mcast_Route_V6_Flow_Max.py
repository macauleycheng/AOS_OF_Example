...
mcast_route_v6_start=[0xff01, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001]
mcast_route_v6_num_max=8191
...
class McastRouteV6FlowMaxTest(app_manager.RyuApp):

    _CONTEXTS = {'dpset': dpset.DPSet}
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(McastRouteV6FlowMaxTest , self).__init__(*args, **kwargs)
    ...
    def create_max_mcast_route_v6_flow(self, datapath):
        ofproto = datapath.ofproto
        parser = datapath.ofproto_parser
        ...
        route_start = list(mcast_route_v6_start)
        actions = [parser.OFPActionGroup(l3_mcast_group_id)]
        for i in range(0, mcast_route_v6_num_max + mcast_route_collision_retry_time, 1):
            ...
            match.set_ipv6_dst(route_start)
    ...
    def table_stats_reply_handler(self, ev):
        ...
        for stat in ev.msg.body:
            ...
            if(stat.table_id == 40):
                if(stat.active_count != mcast_route_v6_num_max):
    ...
    def handler_datapath(self, ev):
        ...
        if ev.enter:
            ...
            self.create_max_mcast_route_v6_flow(ev.dp)
